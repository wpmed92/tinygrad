...
const setupNet = async (device, safetensor) => {
    ...
    const buf_2 = createEmptyBuf(device, 64);;
    const buf_3 = createEmptyBuf(device, 16);;
    const buf_4 = createEmptyBuf(device, 8388608);;
    const buf_5 = createEmptyBuf(device, 73728);;
    const buf_6 = createEmptyBuf(device, 2048);;
    ...
    const buf_12 = createEmptyBuf(device, 2048);;
    const buf_13 = createEmptyBuf(device, 8388608);;
    const buf_14 = createEmptyBuf(device, 9437184);;
    const buf_15 = createEmptyBuf(device, 2048);;
    const buf_16 = createEmptyBuf(device, 2048);;
    const buf_17 = createEmptyBuf(device, 2048);;
    const buf_18 = createEmptyBuf(device, 9437184);;
    const buf_19 = createEmptyBuf(device, 2048);;
    const buf_20 = createEmptyBuf(device, 2048);;
    const buf_21 = createEmptyBuf(device, 2048);;
    const buf_22 = createEmptyBuf(device, 1048576);;
    const buf_23 = createEmptyBuf(device, 2048);;
    const buf_24 = createEmptyBuf(device, 8388608);;
    const buf_25 = createEmptyBuf(device, 1048576);;
    const buf_26 = createEmptyBuf(device, 2048);;
    const buf_27 = createEmptyBuf(device, 8388608);;
    const buf_28 = createEmptyBuf(device, 1048576);;
    const buf_29 = createEmptyBuf(device, 2048);;
    ...
    const buf_34 = createEmptyBuf(device, 1048576);;
    const buf_35 = createEmptyBuf(device, 2048);;
    const buf_36 = createEmptyBuf(device, 2048);;
    const buf_37 = createEmptyBuf(device, 2048);;
    const buf_38 = createEmptyBuf(device, 9437184);;
    const buf_39 = createEmptyBuf(device, 2048);;
    const buf_40 = createEmptyBuf(device, 2048);;
    const buf_41 = createEmptyBuf(device, 2048);;
    const buf_42 = createEmptyBuf(device, 9437184);;
    const buf_43 = createEmptyBuf(device, 2048);;
    const buf_44 = createEmptyBuf(device, 2048);;
    const buf_45 = createEmptyBuf(device, 2048);;
    const buf_46 = createEmptyBuf(device, 9437184);;
    const buf_47 = createEmptyBuf(device, 2048);;
    const buf_48 = createEmptyBuf(device, 2048);;
    const buf_49 = createEmptyBuf(device, 2048);;
    const buf_50 = createEmptyBuf(device, 9437184);;
    const buf_51 = createEmptyBuf(device, 2048);;
    const buf_52 = createEmptyBuf(device, 2048);;
    const buf_53 = createEmptyBuf(device, 2048);;
    const buf_54 = createEmptyBuf(device, 9437184);;
    const buf_55 = createEmptyBuf(device, 2048);;
    const buf_56 = createEmptyBuf(device, 2048);;
    const buf_57 = createEmptyBuf(device, 2048);;
    const buf_58 = createEmptyBuf(device, 9437184);;
    const buf_59 = createEmptyBuf(device, 2048);;
    const buf_60 = createEmptyBuf(device, 2048);;
    const buf_61 = createEmptyBuf(device, 2048);;
    const buf_62 = createEmptyBuf(device, 9437184);;
    const buf_63 = createEmptyBuf(device, 2048);;
    const buf_64 = createEmptyBuf(device, 2048);;
    const buf_65 = createEmptyBuf(device, 2048);;
    const buf_66 = createEmptyBuf(device, 9437184);;
    const buf_67 = createEmptyBuf(device, 2048);;
    const buf_68 = createEmptyBuf(device, 33554432);;
    const buf_69 = createEmptyBuf(device, 9437184);;
    const buf_70 = createEmptyBuf(device, 2048);;
    const buf_71 = createEmptyBuf(device, 33554432);;
    const buf_72 = createEmptyBuf(device, 2048);;
    const buf_73 = createEmptyBuf(device, 2048);;
    const buf_74 = createEmptyBuf(device, 33554432);;
    const buf_75 = createEmptyBuf(device, 9437184);;
    const buf_76 = createEmptyBuf(device, 2048);;
    const buf_77 = createEmptyBuf(device, 2048);;
    const buf_78 = createEmptyBuf(device, 2048);;
    const buf_79 = createEmptyBuf(device, 9437184);;
    const buf_80 = createEmptyBuf(device, 2048);;
    const buf_81 = createEmptyBuf(device, 2048);;
    const buf_82 = createEmptyBuf(device, 2048);;
    const buf_83 = createEmptyBuf(device, 33554432);;
    const buf_84 = createEmptyBuf(device, 9437184);;
    const buf_85 = createEmptyBuf(device, 2048);;
    const buf_86 = createEmptyBuf(device, 2048);;
    const buf_87 = createEmptyBuf(device, 2048);;
    const buf_88 = createEmptyBuf(device, 9437184);;
    const buf_89 = createEmptyBuf(device, 2048);;
    const buf_90 = createEmptyBuf(device, 2048);;
    const buf_91 = createEmptyBuf(device, 2048);;
    const buf_92 = createEmptyBuf(device, 9437184);;
    const buf_93 = createEmptyBuf(device, 2048);;
    const buf_94 = createEmptyBuf(device, 2048);;
    const buf_95 = createEmptyBuf(device, 2048);;
    const buf_96 = createEmptyBuf(device, 9437184);;
    const buf_97 = createEmptyBuf(device, 2048);;
    const buf_98 = createEmptyBuf(device, 134217728);;
    const buf_99 = createEmptyBuf(device, 9437184);;
    ...
    const buf_104 = createEmptyBuf(device, 4718592);;
    const buf_105 = createEmptyBuf(device, 1024);;
    const buf_106 = createEmptyBuf(device, 1024);;
    const buf_107 = createEmptyBuf(device, 1024);;
    const buf_108 = createEmptyBuf(device, 2359296);;
    const buf_109 = createEmptyBuf(device, 524288);;
    const buf_110 = createEmptyBuf(device, 1024);;
    const buf_111 = createEmptyBuf(device, 1024);;
    const buf_112 = createEmptyBuf(device, 1024);;
    const buf_113 = createEmptyBuf(device, 1024);;
    const buf_114 = createEmptyBuf(device, 67108864);;
    const buf_115 = createEmptyBuf(device, 2359296);;
    const buf_116 = createEmptyBuf(device, 1024);;
    const buf_117 = createEmptyBuf(device, 1024);;
    const buf_118 = createEmptyBuf(device, 1024);;
    const buf_119 = createEmptyBuf(device, 2359296);;
    const buf_120 = createEmptyBuf(device, 1024);;
    const buf_121 = createEmptyBuf(device, 1024);;
    const buf_122 = createEmptyBuf(device, 1024);;
    const buf_123 = createEmptyBuf(device, 2359296);;
    const buf_124 = createEmptyBuf(device, 1024);;
    const buf_125 = createEmptyBuf(device, 1024);;
    const buf_126 = createEmptyBuf(device, 1024);;
    const buf_127 = createEmptyBuf(device, 2359296);;
    const buf_128 = createEmptyBuf(device, 1024);;
    const buf_129 = createEmptyBuf(device, 268435456);;
    const buf_130 = createEmptyBuf(device, 2359296);;
    const buf_131 = createEmptyBuf(device, 1024);;
    const buf_132 = createEmptyBuf(device, 268435456);;
    const buf_133 = createEmptyBuf(device, 1024);;
    const buf_134 = createEmptyBuf(device, 1024);;
    const buf_135 = createEmptyBuf(device, 1179648);;
    const buf_136 = createEmptyBuf(device, 512);;
    const buf_137 = createEmptyBuf(device, 134217728);;
    const buf_138 = createEmptyBuf(device, 512);;
    const buf_139 = createEmptyBuf(device, 512);;
    const buf_140 = createEmptyBuf(device, 589824);;
    const buf_141 = createEmptyBuf(device, 131072);;
    const buf_142 = createEmptyBuf(device, 512);;
    const buf_143 = createEmptyBuf(device, 512);;
    const buf_144 = createEmptyBuf(device, 512);;
    const buf_145 = createEmptyBuf(device, 512);;
    const buf_146 = createEmptyBuf(device, 134217728);;
    const buf_147 = createEmptyBuf(device, 589824);;
    const buf_148 = createEmptyBuf(device, 512);;
    const buf_149 = createEmptyBuf(device, 512);;
    const buf_150 = createEmptyBuf(device, 512);;
    const buf_151 = createEmptyBuf(device, 589824);;
    const buf_152 = createEmptyBuf(device, 512);;
    const buf_153 = createEmptyBuf(device, 512);;
    const buf_154 = createEmptyBuf(device, 512);;
    const buf_155 = createEmptyBuf(device, 589824);;
    const buf_156 = createEmptyBuf(device, 512);;
    const buf_157 = createEmptyBuf(device, 512);;
    const buf_158 = createEmptyBuf(device, 512);;
    const buf_159 = createEmptyBuf(device, 134217728);;
    const buf_160 = createEmptyBuf(device, 589824);;
    const buf_161 = createEmptyBuf(device, 512);;
    const buf_162 = createEmptyBuf(device, 512);;
    const buf_163 = createEmptyBuf(device, 512);;
    const buf_164 = createEmptyBuf(device, 3145728);;
    const buf_165 = createEmptyBuf(device, 13824);;
    const buf_166 = createEmptyBuf(device, 12);;
